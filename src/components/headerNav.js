...
const HeaderNav = () => (
    ...
    <div className={headerNavStyles.headerNav}>
        ...
        <div className={headerNavStyles.headerLinkContainer}>
            ...
            <Link to="/" className={headerNavStyles.headerLink}>Send Message</Link>
        </div>
        ...
        <div className={headerNavStyles.headerLinkContainer}>
            ...
            <Link to="/" className={headerNavStyles.headerLink}>Blog</Link>
        </div>
        ...
        <div className={headerNavStyles.headerLinkContainer}>
            ...
            <Link to="/" className={headerNavStyles.headerLink}>About Me</Link>
        </div>
    </div>
